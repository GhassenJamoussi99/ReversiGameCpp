...
TEST_F(PlaceholderTest, CheckHorizontalPlaceholderStatement) {
    reversiboard.cleanBoard();
...
TEST_F(PlaceholderTest, CheckDiagonalPlaceholderStatement) {
    int i,j;
    char opponentPiece;
    reversiboard.cleanBoard();
...
TEST_F(PlaceholderTest, calculatePlaceholderPlacesForPlayerStatement) {
    int i,j;
    char playerPiece;
